...
<a target="_blank" href="https://jaywcjlove.github.io/maslink/?id=6476924627" title="Create Custom Symbols AppStore">
...
2. fix: fix jitter on appearance of menu bar button icons on macOS 27.

## [v3.2.0](https://github.com/jaywcjlove/IconizeFolder/releases/tag/v3.2.0)

1. fix: explicitly show NSMenuItem symbol images on macOS 27+
...
2. fix: fix sidebar selection issue
